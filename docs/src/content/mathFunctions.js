export const mathFunctions = {
  ...
  Triangle: [
    ...
    },
    {
      ...
      description:
        "Calculate the area of a triangle using the lengths of its three sides (Heron's formula)",
      parameters: [
    ...
    },
    {
      ...
      parameters: [
        ...
        { name: "sideC", type: "Float", description: "Length of third side" },
        {
          name: "showLogs",
          type: "Boolean",
          description: "Whether to print calculation logs",
          default: "true",
        },
      ],
      returnType: "Triple<Float, Float, Float>?",
      example:
        "val angles = triangleAngles(3f, 4f, 5f) // Returns (36.9f, 53.1f, 90.0f)",
    },
    {
      name: "triangleSide",
      description:
        "Calculate the length of a side of a triangle knowing the lengths of the other two sides and the angle between them",
      parameters: [
        { name: "sideA", type: "Float", description: "Length of first side" },
        { name: "sideB", type: "Float", description: "Length of second side" },
        {
          name: "angleBetween",
          type: "Float",
          description: "Angle between sideA and sideB in degrees",
        },
      ],
      returnType: "Float",
      ...
      parameters: [
        {
          name: "side",
          type: "Float",
          description: "Length of each side of the equilateral triangle",
        },
      ],
      returnType: "Float",
    ...
    },
    {
      ...
      returnType: "Float",
      example:
        "val perimeter = equilateralTrianglePerimeter(5f) // Returns 15f",
    },
    {
      ...
      parameters: [
        {
          name: "equalSide",
          type: "Float",
          description: "Length of the two equal sides",
        },
    ...
    },
    {
      ...
      returnType: "Float",
      example:
        "val perimeter = isoscelesTrianglePerimeter(5f, 6f) // Returns 16f",
    },
    {
      name: "triangleHeight",
      ...
      parameters: [
        ...
        },
        {
          name: "respectToSide",
          type: "Float",
          description: "Which side to use as the base",
        },
      ],
      returnType: "Float",
      example:
        "val height = triangleHeight(3f, 4f, 5f, 3f) // Returns 4.0f (height with respect to side of length 3)",
    },
    {
      ...
      returnType: "Float",
      example:
        "val semiPerimeter = triangleSemiPerimeter(3f, 4f, 5f) // Returns 6f",
    },
    {
      name: "lawOfSines",
      description:
        "Apply the Law of Sines to find an unknown angle given two sides and an angle",
      parameters: [
        {
          name: "sideA",
          type: "Float",
        ...
        },
        {
          name: "angleA",
          type: "Float",
          description: "Angle (in radians) opposite to sideA",
        },
      ],
      returnType: "Float",
      example:
        "val angleB = lawOfSines(3f, 4f, PI/6f) // Returns the angle (in radians) opposite to sideB",
    },
    {
      name: "lawOfCosines",
      description:
        "Apply the Law of Cosines to find an unknown angle in a triangle given all three sides",
      parameters: [
        {
          name: "sideA",
          type: "Float",
      ...
      returnType: "Float",
      example:
        "val angleC = lawOfCosines(3f, 4f, 5f) // Returns the angle (in radians) opposite to sideC",
    },
  ],
  "Pythagorean Theorem": [
    {
    ...
    },
    {
      ...
      description:
        "Calculate a leg of a right triangle when given the other leg and the hypotenuse",
      parameters: [
        {
          name: "sideA",
          type: "Float",
          description: "Length of the known leg",
        },
        {
          name: "hypotenuse",
          type: "Float",
  ...
  "3D Shapes": [
      ...
      parameters: [
        {
          name: "side",
          type: "Float",
          description: "Length of the cube's side",
        },
      ],
      returnType: "Float",
    ...
    },
    {
      ...
      returnType: "Float",
      example:
        "val area = rectangularPrismSurfaceArea(5f, 3f, 2f) // Returns 62f",
    },
    {
      name: "sphereVolume",
      ...
      parameters: [
        {
          name: "baseLength",
          type: "Float",
          description: "Length of the pyramid base",
        },
        {
          name: "baseWidth",
          type: "Float",
          description: "Width of the pyramid base",
        },
  ...
  "2D Shapes": [
    {
      name: "arcLength",
      description:
        "Calculate the length of an arc given radius and angle in radians",
      parameters: [
        { name: "radius", type: "Float", description: "Radius of the circle" },
        {
          name: "angleRadians",
          type: "Float",
          description: "Angle of the arc in radians",
        },
      ],
      returnType: "Float",
      example:
        "val length = arcLength(5f, PI.toFloat()/2) // Returns 7.85f (quarter circle)",
    },
    {
      name: "sectorArea",
      description:
        "Calculate the area of a sector given radius and angle in radians",
      parameters: [
        { name: "radius", type: "Float", description: "Radius of the circle" },
        {
          name: "angleRadians",
          type: "Float",
          description: "Angle of the sector in radians",
        },
      ],
      returnType: "Float",
      example:
        "val area = sectorArea(5f, PI.toFloat()/2) // Returns 19.63f (quarter circle)",
    },
    {
      name: "trapezoidArea",
      ...
      parameters: [
        {
          name: "top",
          type: "Float",
          description: "Length of the top parallel side",
        },
        {
          name: "bottom",
          type: "Float",
          description: "Length of the bottom parallel side",
        },
        {
          name: "height",
          type: "Float",
          description: "Height between the parallel sides",
        },
      ],
      returnType: "Float",
    ...
    },
    {
      ...
      returnType: "Float",
      example:
        "val area = regularPolygonArea(6, 4f) // Returns 41.57f (regular hexagon)",
    },
    {
      ...
      parameters: [
        { name: "base", type: "Float", description: "Length of the base" },
        {
          name: "height",
          type: "Float",
          description: "Height perpendicular to the base",
        },
      ],
      returnType: "Float",
      ...
      parameters: [
        {
          name: "diagonal1",
          type: "Float",
          description: "Length of first diagonal",
        },
        {
          name: "diagonal2",
          type: "Float",
          description: "Length of second diagonal",
        },
      ],
      returnType: "Float",
    ...
    },
    {
      ...
      parameters: [
        ...
        },
        {
          name: "semiMinorAxis",
          type: "Float",
          description: "Length of the semi-minor axis",
        },
      ],
      returnType: "Float",
  ...
  Vectors: [
    {
      ...
      example:
        "val result = vectorAdd(floatArrayOf(1f, 2f, 3f), floatArrayOf(4f, 5f, 6f)) // Returns [5f, 7f, 9f]",
    },
    {
      name: "vectorSubtract",
      description:
        "Subtract one vector from another (both must have the same dimension)",
      parameters: [
        {
          name: "vec1",
          type: "FloatArray",
      ...
      returnType: "FloatArray",
      example:
        "val result = vectorSubtract(floatArrayOf(5f, 7f, 9f), floatArrayOf(1f, 2f, 3f)) // Returns [4f, 5f, 6f]",
    },
    {
      name: "dotProduct",
      ...
      returnType: "Float",
      example:
        "val result = dotProduct(floatArrayOf(1f, 2f, 3f), floatArrayOf(4f, 5f, 6f)) // Returns 32f",
    },
    {
      name: "crossProduct",
      ...
      returnType: "FloatArray",
      example:
        "val result = crossProduct(floatArrayOf(1f, 0f, 0f), floatArrayOf(0f, 1f, 0f)) // Returns [0f, 0f, 1f]",
    },
    {
      ...
      returnType: "Float",
      example:
        "val magnitude = vectorMagnitude(floatArrayOf(3f, 4f)) // Returns 5f",
    },
    {
      name: "unitVector",
      description:
        "Calculate the unit vector (vector with magnitude 1) in the same direction as the input vector",
      parameters: [
        { name: "vec", type: "FloatArray", description: "Input vector" },
      ],
      returnType: "FloatArray",
      example:
        "val unit = unitVector(floatArrayOf(3f, 0f, 0f)) // Returns [1f, 0f, 0f]",
    },
    {
      ...
      returnType: "Float",
      example:
        "val angle = angleBetweenVectors(floatArrayOf(1f, 0f), floatArrayOf(0f, 1f)) // Returns PI/2 (90 degrees)",
    },
  ],
  "Coordinate Geometry": [
    {
    ...
    },
    {
      ...
      returnType: "Float",
      example:
        "val dist = distance3D(1f, 2f, 3f, 4f, 5f, 6f) // Returns 5.196f",
    },
    {
      name: "midpoint2D",
    ...
    },
    {
      ...
      returnType: "Triple<Float, Float, Float>",
      example:
        "val mid = midpoint3D(2f, 4f, 6f, 4f, 8f, 10f) // Returns Triple(3f, 6f, 8f)",
    },
    {
      name: "slope",
    ...
    },
    {
      name: "lineEquation",
      description:
        "Calculate the coefficients of a line equation (ax + by + c = 0) passing through two points",
      parameters: [
        {
          name: "x1",
          type: "Float",
      ...
      returnType: "Triple<Float, Float, Float>",
      example:
        "val coeffs = lineEquation(1f, 1f, 2f, 2f) // Returns Triple(1f, -1f, 0f) for the equation x - y = 0",
    },
    {
      name: "distancePointToLine",
      description:
        "Calculate the distance from a point to a line defined by the equation ax + by + c = 0",
      parameters: [
        ...
        { name: "y", type: "Float", description: "y-coordinate of the point" },
        {
          name: "a",
          type: "Float",
          description: "a coefficient in the line equation ax + by + c = 0",
        },
        {
          name: "b",
          type: "Float",
          description: "b coefficient in the line equation ax + by + c = 0",
        },
        {
          name: "c",
          type: "Float",
          description: "c coefficient in the line equation ax + by + c = 0",
        },
      ],
      returnType: "Float",

      example:
        "val dist = distancePointToLine(2f, 3f, 1f, -1f, 0f) // Distance from point (2,3) to line x - y = 0",
    },
    {
      name: "areCollinear",
      description:
      ...
      parameters: [
        ...
        },
        {
          name: "x3",
          type: "Float",
          description: "x-coordinate of third point",
        },
        {
          name: "y3",
          type: "Float",
          description: "y-coordinate of third point",
        },
      ],
      returnType: "Boolean",
      example:
        "val collinear = areCollinear(1f, 1f, 2f, 2f, 3f, 3f) // Returns true as points lie on the same line",
    },
  ],
};
